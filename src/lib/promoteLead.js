...
export function buildVerifiedLeadRow(dbLead) {
  return {
    ...
    // FIX: pipelineSave.js sets followers_count on the leads_staging row
    // for Instagram/YouTube leads, but this mapper never carried it over
    // to leads_verified — follower count silently disappeared the moment
    // a social lead was promoted.
    followers_count: dbLead.followers_count ?? null,
