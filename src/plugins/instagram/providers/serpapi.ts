/** plugins/instagram/providers/serpapi.ts — moved from instagram/serpapi.ts, unchanged behavior. */
...
async function fetchInstagramSerpApi(input: InstagramSerpApiInput, _ctx: ProviderRunContext): Promise<any[]> {
...
export const instagramSerpApiProvider: SourceProvider<InstagramSerpApiInput, any> = {
  name: "instagram-serpapi",
  fetch: fetchInstagramSerpApi,
};
